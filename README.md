...
Added new lindbergh loader v2.x.x compatibility with autogenerated "default config" and "default input" files. 

Not so much tested outside my hardware and setup but it must work also on your side. 
